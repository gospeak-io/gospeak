...
object Mappings {
  ...
  val externalEventName: Mapping[ExternalEvent.Name] = nonEmptyTextMapping(ExternalEvent.Name, _.value, Constraints.maxLength(Values.maxLength.title))
  ...
  val externalProposalTitle: Mapping[ExternalProposal.Title] = nonEmptyTextMapping(ExternalProposal.Title, _.value, Constraints.maxLength(Values.maxLength.title))

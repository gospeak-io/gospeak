...
import gospeak.libs.sql.jooqdb.tables.records.PostsRecord
...
)
{
  ...
  def this(alias : String) = {
    this(DSL.name(alias), null, null, gospeak.libs.sql.jooqdb.tables.Posts.POSTS, null)
  }
   ...
   */
  def this(alias : Name) = {
    this(alias, null, null, gospeak.libs.sql.jooqdb.tables.Posts.POSTS, null)
  }

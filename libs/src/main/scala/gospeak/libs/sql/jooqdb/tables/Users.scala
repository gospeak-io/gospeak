...
import gospeak.libs.sql.jooqdb.tables.records.UsersRecord
...
)
{
  ...
  def this(alias : String) = {
    this(DSL.name(alias), null, null, gospeak.libs.sql.jooqdb.tables.Users.USERS, null)
  }
   ...
   */
  def this(alias : Name) = {
    this(alias, null, null, gospeak.libs.sql.jooqdb.tables.Users.USERS, null)
  }

...
import gospeak.libs.sql.testingutils.jooqdb.tables.records.KindsRecord
...
)
{
  ...
  def this(alias : String) = {
    this(DSL.name(alias), null, null, gospeak.libs.sql.testingutils.jooqdb.tables.Kinds.KINDS, null)
  }
   ...
   */
  def this(alias : Name) = {
    this(alias, null, null, gospeak.libs.sql.testingutils.jooqdb.tables.Kinds.KINDS, null)
  }

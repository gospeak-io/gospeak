...
object User {
  def apply(d: Data, now: Instant): User =
    new User(Id.generate(), d.slug, d.status, d.firstName, d.lastName, d.email, None, d.avatar, d.bio, d.company, d.location, d.phone, d.website, d.social, now, now)

...
class PROPOSALS private(getAlias: Option[String] = Some("p")) extends Table.SqlTable("PUBLIC", "proposals", getAlias) {
  ...
  val ID: SqlFieldRaw[Proposal.Id, PROPOSALS] = SqlField(this, "id", "CHAR(36) NOT NULL", JdbcType.Char, nullable = false, 1)
  ...
  val STATUS: SqlFieldRaw[Proposal.Status, PROPOSALS] = SqlField(this, "status", "VARCHAR(10) NOT NULL", JdbcType.VarChar, nullable = false, 5)
  val TITLE: SqlFieldRaw[Talk.Title, PROPOSALS] = SqlField(this, "title", "VARCHAR(120) NOT NULL", JdbcType.VarChar, nullable = false, 6)
  val DURATION: SqlFieldRaw[FiniteDuration, PROPOSALS] = SqlField(this, "duration", "BIGINT NOT NULL", JdbcType.BigInt, nullable = false, 7)
  val DESCRIPTION: SqlFieldRaw[Markdown, PROPOSALS] = SqlField(this, "description", "VARCHAR(4096) NOT NULL", JdbcType.VarChar, nullable = false, 8)
  val MESSAGE: SqlFieldRaw[Markdown, PROPOSALS] = SqlField(this, "message", "VARCHAR(4096) DEFAULT '' NOT NULL", JdbcType.VarChar, nullable = false, 18)
  val SPEAKERS: SqlFieldRaw[NonEmptyList[User.Id], PROPOSALS] = SqlField(this, "speakers", "VARCHAR(184) NOT NULL", JdbcType.VarChar, nullable = false, 9)
  val SLIDES: SqlFieldRaw[Url.Slides, PROPOSALS] = SqlField(this, "slides", "VARCHAR(1024)", JdbcType.VarChar, nullable = true, 10)
  val VIDEO: SqlFieldRaw[Url.Video, PROPOSALS] = SqlField(this, "video", "VARCHAR(1024)", JdbcType.VarChar, nullable = true, 11)
  val TAGS: SqlFieldRaw[List[Tag], PROPOSALS] = SqlField(this, "tags", "VARCHAR(150) NOT NULL", JdbcType.VarChar, nullable = false, 12)
  val ORGA_TAGS: SqlFieldRaw[List[Tag], PROPOSALS] = SqlField(this, "orga_tags", "VARCHAR(150) DEFAULT '' NOT NULL", JdbcType.VarChar, nullable = false, 17)
  val CREATED_AT: SqlFieldRaw[Instant, PROPOSALS] = SqlField(this, "created_at", "TIMESTAMP NOT NULL", JdbcType.Timestamp, nullable = false, 13)
  ...
  val UPDATED_AT: SqlFieldRaw[Instant, PROPOSALS] = SqlField(this, "updated_at", "TIMESTAMP NOT NULL", JdbcType.Timestamp, nullable = false, 15)

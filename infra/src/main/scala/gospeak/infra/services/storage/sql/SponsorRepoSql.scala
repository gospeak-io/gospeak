...
object SponsorRepoSql {
  ...
  val tableFull: Table = table
    ...
    .copy(filters = List(
      Table.Filter.Bool.fromNow("active", "Is active", "s.start", "s.finish")))

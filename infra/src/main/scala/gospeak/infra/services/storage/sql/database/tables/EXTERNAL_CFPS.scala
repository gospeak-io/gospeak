...
class EXTERNAL_CFPS private(getAlias: Option[String] = Some("ec")) extends Table.SqlTable("PUBLIC", "external_cfps", getAlias) {
  ...
  val ID: SqlFieldRaw[ExternalCfp.Id, EXTERNAL_CFPS] = SqlField(this, "id", "CHAR(36) NOT NULL", JdbcType.Char, nullable = false, 1)
  ...
  val DESCRIPTION: SqlFieldRaw[Markdown, EXTERNAL_CFPS] = SqlField(this, "description", "VARCHAR(4096) NOT NULL", JdbcType.VarChar, nullable = false, 2)
  val BEGIN: SqlFieldRaw[LocalDateTime, EXTERNAL_CFPS] = SqlField(this, "begin", "TIMESTAMP", JdbcType.Timestamp, nullable = true, 3)
  val CLOSE: SqlFieldRaw[LocalDateTime, EXTERNAL_CFPS] = SqlField(this, "close", "TIMESTAMP", JdbcType.Timestamp, nullable = true, 4)
  val URL: SqlFieldRaw[Url, EXTERNAL_CFPS] = SqlField(this, "url", "VARCHAR(1024) NOT NULL", JdbcType.VarChar, nullable = false, 5)
  val CREATED_AT: SqlFieldRaw[Instant, EXTERNAL_CFPS] = SqlField(this, "created_at", "TIMESTAMP NOT NULL", JdbcType.Timestamp, nullable = false, 6)
  ...
  val UPDATED_AT: SqlFieldRaw[Instant, EXTERNAL_CFPS] = SqlField(this, "updated_at", "TIMESTAMP NOT NULL", JdbcType.Timestamp, nullable = false, 8)

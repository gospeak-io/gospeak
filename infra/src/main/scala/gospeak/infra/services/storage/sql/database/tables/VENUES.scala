...
class VENUES private(getAlias: Option[String] = Some("v")) extends Table.SqlTable("PUBLIC", "venues", getAlias) {
  ...
  val ID: SqlFieldRaw[Venue.Id, VENUES] = SqlField(this, "id", "CHAR(36) NOT NULL", JdbcType.Char, nullable = false, 1)
  ...
  val ADDRESS: SqlFieldRaw[GMapPlace, VENUES] = SqlField(this, "address", "VARCHAR(4096) NOT NULL", JdbcType.VarChar, nullable = false, 4)
  val ADDRESS_ID: SqlFieldRaw[String, VENUES] = SqlField(this, "address_id", "VARCHAR(150) DEFAULT '' NOT NULL", JdbcType.VarChar, nullable = false, 16)
  val ADDRESS_LAT: SqlFieldRaw[Double, VENUES] = SqlField(this, "address_lat", "DOUBLE PRECISION NOT NULL", JdbcType.Double, nullable = false, 5)
  val ADDRESS_LNG: SqlFieldRaw[Double, VENUES] = SqlField(this, "address_lng", "DOUBLE PRECISION NOT NULL", JdbcType.Double, nullable = false, 6)
  val ADDRESS_LOCALITY: SqlFieldRaw[String, VENUES] = SqlField(this, "address_locality", "VARCHAR(150)", JdbcType.VarChar, nullable = true, 17)
  val ADDRESS_COUNTRY: SqlFieldRaw[String, VENUES] = SqlField(this, "address_country", "VARCHAR(30) NOT NULL", JdbcType.VarChar, nullable = false, 7)
  val NOTES: SqlFieldRaw[Markdown, VENUES] = SqlField(this, "notes", "VARCHAR(4096) NOT NULL", JdbcType.VarChar, nullable = false, 8)
  val ROOM_SIZE: SqlFieldRaw[Int, VENUES] = SqlField(this, "room_size", "INT", JdbcType.Integer, nullable = true, 9)
  val MEETUPGROUP: SqlFieldRaw[MeetupGroup.Slug, VENUES] = SqlField(this, "meetupGroup", "VARCHAR(80)", JdbcType.VarChar, nullable = true, 10)
  val MEETUPVENUE: SqlFieldRaw[MeetupVenue.Id, VENUES] = SqlField(this, "meetupVenue", "BIGINT", JdbcType.BigInt, nullable = true, 11)
  val CREATED_AT: SqlFieldRaw[Instant, VENUES] = SqlField(this, "created_at", "TIMESTAMP NOT NULL", JdbcType.Timestamp, nullable = false, 12)
  ...
  val UPDATED_AT: SqlFieldRaw[Instant, VENUES] = SqlField(this, "updated_at", "TIMESTAMP NOT NULL", JdbcType.Timestamp, nullable = false, 14)

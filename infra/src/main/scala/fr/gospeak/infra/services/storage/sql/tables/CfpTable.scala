...
object CfpTable {
  ...
  private[tables] val fields = Seq("id", "slug", "name", "description", "group_id", "created", "created_by", "updated", "updated_by")
  ...
  private def values(e: Cfp): Fragment =
    fr0"${e.id}, ${e.slug}, ${e.name}, ${e.description}, ${e.group}, ${e.info.created}, ${e.info.createdBy}, ${e.info.updated}, ${e.info.updatedBy}"

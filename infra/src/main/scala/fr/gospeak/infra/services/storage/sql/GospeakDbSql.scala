...
class GospeakDbSql(dbConf: DatabaseConf, gsConf: GospeakConf) extends GospeakDb {
  ...
  def insertMockData(conf: GospeakConf): IO[Done] = {
    ...
    val event7 = event(humanTalks, Some(cfp1), "2020-01", "HumanTalks Paris Janvier 2019", "2019-01-14", userDemo, Some(100), venue = Some(venue1), description = groupDefaultSettings.event.description, published = false)

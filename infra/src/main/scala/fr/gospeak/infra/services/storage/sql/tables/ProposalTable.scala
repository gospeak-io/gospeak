...
object ProposalTable {
  ...
  def selectPage(group: Group.Id, params: Page.Params): (doobie.Query0[Proposal], doobie.Query0[Long]) = {
  ...
  def selectPage(talk: Talk.Id, params: Page.Params): (doobie.Query0[(Group, Proposal)], doobie.Query0[Long]) = {

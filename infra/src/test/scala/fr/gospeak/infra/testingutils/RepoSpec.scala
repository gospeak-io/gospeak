...
import fr.gospeak.libs.scalautils.domain.{Avatar, EmailAddress, Page, Url}
import org.scalatest.{BeforeAndAfterEach, FunSpec, Matchers}

class RepoSpec extends FunSpec with Matchers with BeforeAndAfterEach with RandomDataGenerator {
  ...
  protected val eventData: Event.Data = random[Event.Data]

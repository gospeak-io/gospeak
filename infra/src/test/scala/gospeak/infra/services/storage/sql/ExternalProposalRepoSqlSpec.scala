...
object ExternalProposalRepoSqlSpec {
  ...
  val commonFields: String = mapFields("id, external, talk_id, talk_slug, talk_duration, cfp_id, cfp_slug, cfp_name, event_id, event_slug, event_name, event_start, event_ext_id, event_ext_name, event_ext_start, title, status, duration, speakers, tags, created_at, created_by, updated_at, updated_by", "p." + _)

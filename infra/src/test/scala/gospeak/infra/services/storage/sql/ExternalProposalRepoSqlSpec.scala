...
object ExternalProposalRepoSqlSpec {
  ...
  val commonFields: String = mapFields("id, external, talk_id, talk_slug, talk_duration, group_id, group_slug, group_name, group_logo, cfp_id, cfp_slug, cfp_name, event_id, event_slug, event_name, event_kind, event_start, event_ext_id, event_ext_name, event_ext_kind, event_ext_logo, event_ext_start, event_ext_url, event_ext_proposal_url, title, status, duration, speakers, slides, video, tags, created_at, created_by, updated_at, updated_by", "p." + _)
